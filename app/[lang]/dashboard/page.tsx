...
import { useRouter, useSearchParams } from "next/navigation"; // للوصول إلى الـ router
        ...
        <div className="container mx-auto">
          <div className="">
            <div className="grid grid-cols-1 mt-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 " dir='ltr'>
              {loading ? (
                <>
                  <div className="bg-white bg-opacity-5 rounded-lg overflow-hidden shadow-md w-full max-w-xs mx-auto animate-pulse">
