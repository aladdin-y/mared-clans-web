...
const Navbar = () => {
 ...
 <button onClick={() => router.push(`${i18n?.language}/commands`)} className="text-sm hover:text-[#6f74f5] transition-colors">
      {t('commands',"Commands")}
              </button>
        ...
        {isMobileMenuOpen && (
          ...
          ref={menuRef}
            ...
            className="md:hidden bg-[#1a1a1a] bg-opacity-80 backdrop-blur-md mt-2 rounded-xl shadow-lg max-w-7xl mx-auto px-6 py-4 space-y-3"          >
              <button onClick={() => router.push(`${i18n?.language}/commands`)} className="block text-sm hover:text-[#6f74f5] transition-colors">
                {t('commands', "Commands")}
              </button>
              <button onClick={() => router.push(`https://discord.gg/YGWdsJx7UX`)} className="block text-sm hover:text-[#6f74f5] transition-colors">
                {t('contactus', "Contact us")}
              </button>
              {
                IslogIn.status ?
